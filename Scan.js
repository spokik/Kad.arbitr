...
(function() {
    ...
    function checkReload() {
        ...
        checkbatton.onmouseover = function(checkbatton) {
            ...
            let checkArray = {isk : document.getElementsByClassName(`b-popup-sj-link js-popup-sj-link js-popup-sj-link--upload`)[0].innerText}
        ...
        const saveButtonElem = document.getElementsByClassName(`b-popup-button js-upload-submit`)[0]
